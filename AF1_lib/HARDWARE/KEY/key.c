...
vu8 grafnum=1,tempshuzhi,vernum=106,hguestnum=222,gonglvshishu=0,tempshuzhi2;
			     ...
			     if(h<200)
				   {  
					    	  ...
					    	  switch(grafnum)
								{				 
									...
									case 3:	//显示无功功率	 
										...
										case 4:	//显示电流
										Clera_lcd();
										Graf_C_cuirrent(dianliuzhi_A,A);
										break;
										case 5:	//显示电流
										Clera_lcd();
										Graf_C_cuirrent(dianliuzhi_C,C);
										break;
										case 6:	//显示温度 
										Clera_lcd();
										Graf_temp(tempshuzhi,tempshuzhi2);
										break;
					 ...
					 if(grafnum==1&&zhongduan_flag_warn_volt==0)/*在id 界面设置id号*/
						...
						if(grafnum==7&&zhongduan_flag==0)/*在id 界面设置id号*/
						{
					             ligt_time=16;
							id_num++;
